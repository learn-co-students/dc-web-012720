...
#given a player's name, return their entire hash
def get_player_info(player_name)
  #iterate through game_hash
  game_hash.each do |team_location, team_data|
    #iterate through the players array 
    team_data[:players].each do |player|
      #check if the name attribute is player_name
      if player[:player_name] == player_name
        #return the entire player's hash of data
        return player
      end 
    end 
  end 
...
#given a name, output should be the number of points they scored 
